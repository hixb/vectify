...
export default defineComponent({
  ...
  setup() {
    ...
    ['path', { fillRule: 'evenodd', d: 'M6.64 9.781a2.14 2.14 0 0 0-2.14 2.14v5.015A4.564 4.564 0 0 0 9.063 21.5h6.558a4.563 4.563 0 0 0 4.563-4.564v-5.015a2.14 2.14 0 0 0-2.139-2.14z', clipRule: 'evenodd', opacity: 0.4 }],
    ['path', { fillRule: 'evenodd', d: 'M11.397 17.405a.946.946 0 1 1 1.89 0 .946.946 0 0 1-1.89 0', clipRule: 'evenodd' }]
    ]
